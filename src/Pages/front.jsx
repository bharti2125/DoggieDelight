  ...
  return (
    <div className="front">
      <section id="title" className="gradient-background">
        <div className="container-nav col-xxl-8 px-4">
          <div className="row flex-lg-row-reverse align-items-center g-5 pt-7">
            ...
            <div className="col-lg-6">
              <h1 className="display-5 fw-bold text-body-emphasis lh-1 mb-3">
                Search and Buy new and interesting dogs nearby.
              </h1>
            </div>
          </div>
        </div>
      ...
      <section id="features">
        ...
        <div className="container py-5 align-items-center">
          <h2>
            "I have four paws and a loving heart, making me the most loyal
            friend."
          </h2>
          <img
            className="profile-image mt-5"
            src="./images/dog-breeds-in-india13.jpg"
          />
          <p className="col-lg-8 mx-auto lead mt-2">Breeds,Indian Dog</p>
        </div>
      </section>
      <section id="pricing">
        ...
        <div className="row row-cols-1 row-cols-md-3 mb-3 text-center">
          <div className="col">
            <div className="card mb-4 rounded-3 shadow-sm">
              <div className="card-header py-3">
                <h4 className="my-0 fw-normal">Indian Pariah</h4>
              </div>
              <div className="card-body">
                <h1 className="card-title pricing-card-title">
                  ₹500<small className="text-body-secondary fw-light">/mo</small>
                </h1>
          ...
          <div className="col">
            <div className="card mb-4 rounded-3 shadow-sm">
              <div className="card-header py-3">
                <h4 className="my-0 fw-normal">Rajapalayam</h4>
              </div>
              <div className="card-body">
                <h1 className="card-title pricing-card-title">
                  ₹1000<small className="text-body-secondary fw-light">/mo</small>
                </h1>
                <ul className="list-unstyled mt-3 mb-4">
          ...
          <div className="col">
            <div className="card mb-4 rounded-3 shadow-sm border-dark">
              <div className="card-header py-3 text-bg-dark border-dark">
                <h4 className="my-0 fw-normal">Mudhol Hound</h4>
              </div>
              <div className="card-body">
                <h1 className="card-title pricing-card-title">
                  ₹2000<small className="text-body-secondary fw-light">/mo</small>
                </h1>
                <ul className="list-unstyled mt-3 mb-4">
